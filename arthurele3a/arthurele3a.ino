#include <Keypad.h> // BIBLIOTECA PARA O FUNCIONAMENTO DO TECLADO DE MEMBRANA, SUGIRO FAZER O DOWNLOAD DE .ZIP
#include <Servo.h> // BIBLIOTECA PARA O FUNCIONAMENTO DO SERVO, SUGIRO FAZER O DOWNLOAD DE .ZIP
 
Servo servo_Motor; //OBJETO DO TIPO SERVO, NOSSO MOTOR
